...
void main() {
  ...
  group('hex color', () {
    ...
    test('Color with transparent', () {
      expect(
        HexColor('#B1FFFFFF').value,
        equals(const Color(0xB1FFFFFF).value),
      );
      expect(
        HexColor('#00FFFFFF').value,
        equals(const Color(0x00FFFFFF).value),
      );
  ...
  group('Helpers', () {
    ...
    test('mix', () {
      expect(
        const Color(0xFFFFFFFF).mix(const Color(0xFF000000), 1),
        const Color(0xFF000000),
      );
      expect(
        const Color(0xFFFFFFFF).mix(const Color(0xFF000000), .5),
        const Color(0xFF7F7F7F),
      );
      expect(
        const Color(0xFFB5A642).mix(const Color(0xFF6C541E), .37),
        const Color(0xFF998734),
      );
      expect(
        const Color(0xFFFF0000).mix(const Color(0xFF00FF00), .25),
